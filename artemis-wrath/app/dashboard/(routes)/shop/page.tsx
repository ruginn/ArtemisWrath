...
const Settings = () => {
  ...
  return (
    <div className='w-screen sm:w-[calc(100vw-96px)] lg:w-[calc(100vw-256px)] flex flex-col items-center justify-center'>
      ...
      <div className='flex w-full justify-center gap-8 m-8'>
        <div className='cursor-pointer w-1/4 h-[650px] flex flex-col items-center bg-gray-900 rounded-3xl border-4 border-gray-300 hover:scale-105'>
          ...
          <Image
            ...
            height={256}
            alt='smallChest'
            className='rounded-3xl border-amber-400 border-solid border-2'
          ></Image>
        </div>
        <div className='cursor-pointer w-1/4 h-[650px] flex flex-col items-center bg-gray-900 rounded-3xl border-4 border-gray-300 hover:scale-105'>
