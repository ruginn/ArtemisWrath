...
const NightmareRequiem = () => {
  ...
  useEffect(() => {
    const getCards = async () => {
      const res: Card[] = await fetch('/api/sets/nightmarerequiem', {
        cache: 'no-cache',
      }).then((res) => res.json());
      // console.log(res)
      setCardSet(res);
  ...
  return (
    <div className='flex flex-col items-center'>
      <h1 className='ml-12 self-start'>Nightmare Requiem</h1>
...
export default NightmareRequiem;
