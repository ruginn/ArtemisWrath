...
import ClashGold from '@/public/Images/backgrounds/ClashGold.png';
  ...
  return (
    <div className='mt-20 md:mt-28 w-full flex flex-col justify-center'>
      <div className='w-full flex flex-col items-center px-10 sm:px-16 '>
        <h1 className='sm:text-lg md:text-4xl font-bold text-center '>
          Unleash the power of creatures in Artemis&apos; Wrath – Where Strategy
          Meets Myth!
        </h1>
        <h3 className='sm:text-base md:text-2xl text-center'>
          Artemis&apos; Wrath isn&apos;t just a game; it&apos;s a battleground
          of wits. Craft your deck, anticipate your foes, and ascend to victory.
        </h3>
      </div>
      <div className='w-full flex justify-evenly p-4 md:p-12 md:gap-3'>
        ...
        <div className='w-[30%] h-36 md:w-64 md:h-72 bg-[#CCB075] rounded-xl flex flex-col items-center justify-center drop-shadow-2xl relative'>
          <Image
            ...
            className='w-full h-full absolute rounded-xl -z-10 blur-[2px] opacity-70'
          />
          <h3 className='sm:text-xl md:text-5xl font-bold text-white'>Clash</h3>
        ...
        <div className='w-[30%] h-36 md:w-64 md:h-72 bg-[#844C32] rounded-xl flex flex-col items-center justify-center drop-shadow-2xl relative'>
          <Image
            ...
            className='w-full h-full absolute rounded-xl -z-10 blur-[2px] opacity-70'
          />
          <h3 className='sm:text-xl md:text-5xl font-bold text-white'>
            Collect
          </h3>
      ...
      <Image src={Mountains} alt='Mountains' className='w-full' />
    </div>
  );
};
